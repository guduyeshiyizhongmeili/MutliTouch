...
public class CircleView extends View {
    ...
    public CircleView(Context context, @Nullable AttributeSet attrs) {
        ...
        circleX = a.getDimension(R.styleable.CircleView_circleX, 50);
        circleY = a.getDimension(R.styleable.CircleView_circleY, 50);
        radius = a.getDimension(R.styleable.CircleView_radius, 50);
        a.recycle();
